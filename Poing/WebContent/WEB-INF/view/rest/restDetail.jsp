					...
					<div class="inner">
						<div class="title">
							<span class="name"> ${dto.rest_name } </span> <span class="info">
								지역코드:${dto.rest_loc_seq} ${dto.rest_food_type}</span>
									...
									<div class="rest_starpoint">
										<c:forEach varStatus="status" var="i" begin="1" end="10"
											...
											<c:if test="${i <= tenpoint }">
												<c:if test="${i%2 ne 0 }">
													<i class="icon star large odd active" data-id=""
											...
											<c:if test="${i > tenpoint }">
												<c:if test="${i%2 ne 0 }">
													<i class="icon star large odd " data-id=""
														data-index="${status.index}" style=""></i>
												</c:if>
												<c:if test="${i%2 eq 0 }">
		...
		<div id="content_wrap">
			<div id="content" class="detail info">
				<ul class="tab">
					...
					<li class="item "><a href="/restaurant/detail/35740?photo">포토</a>
					</li>
					<li class="item "><a href="/restaurant/detail/35740?review">리뷰(19)</a>
					</li>
					<li class="item "><a href="/restaurant/detail/35740?menu">메뉴</a>
					</li>
					<li class="item "><a href="/restaurant/detail/35740?map">지도</a>
					</li>
				</ul>
				<!-- product 부분 -->
					...
					<div class="section single reservation_histories">
						...
						<div class="body">
							3840님이 2019.5.25 오후 7:00, 2명 예약하셨습니다.<span><script>
								...
								document
										.write(moment('2019-05-17 11:30:19')
												.locale('ko').fromNow());
							</script>6일 전</span>
						</div>
					</div>
