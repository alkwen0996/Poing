...
<div id="scripts">
                  ...
                  if (response.status) {
                    ...
                    $.each(response.data.ac_keywords, function (e) {
                      ...
                      if (this.name.search(esc) >= 0) {
                        ...
                        this.name = src.slice(0, pos) + "<span class='highlight'>" + response.meta
                          .ac_keyword + "</span>" + src.slice(pos + response.meta.ac_keyword.length)
                      }
    ...
    $(document).ready(function () {
      ...
      $("#nav_area>.box>.neighborhood input").change(function () {
        ...
        $("#nav_area>.box>.neighborhood input[id^=" + hash + "]").prop('checked', state).parent().toggleClass(
          'selected', state);
      ...
      $("#nav_btn").click(function () {
        window.search({
          ...
          reset: ['food_detail_types', 'price_description', 'additional_info', 'table_styles', 'liquors',
            'parking', 'order_rule', 'theme_childe_sub3', 'theme_childe_url', 'r_num', 'page'
          ]
        });
      });
      // box button click
