...
<head>
<meta charset="UTF-8">
<title>jsp/sevlet class SIST168 (2019. 5. 24. - 오전 8:59:39)</title>
			...
			<div id="nav_wrap" class="fixed">
				<div class="container_wrap">
					<div id="nav_container" class="">
						...
						<!-- logo section -->
						<a id="nav_logo" href="/seoul"><img class="logo"
						...
						<div id="nav_area" class="search sel">
							...
							<div class="box">
								<ul class="district">
									<li data-dist="6914b4770337c90465bde5e773fbd8c2"
										class="selected">인기지역<span>&gt;</span></li>
								...
								<div class="neighborhood">
									<ul class="content scroll selected"
										data-dist="6914b4770337c90465bde5e773fbd8c2">
										<li><input type="checkbox"
											id="ca460332316d6da84b08b9bcf39b687b" value="1892"><label
											for="ca460332316d6da84b08b9bcf39b687b">가로수길</label></li>
										<li><input type="checkbox"
											id="e06f967fb0d355592be4e7674fa31d26" value="1896"><label
											for="e06f967fb0d355592be4e7674fa31d26">강남역</label></li>
										<li><input type="checkbox"
											id="9fdb62f932adf55af2c0e09e55861964" value="1900"><label
											for="9fdb62f932adf55af2c0e09e55861964">건대</label></li>
										<li><input type="checkbox"
											id="c91591a8d461c2869b9f535ded3e213e" value="1904"><label
											for="c91591a8d461c2869b9f535ded3e213e">경리단길</label></li>
										<li><input type="checkbox"
											id="65699726a3c601b9f31bf04019c8593c" value="1908"><label
											for="65699726a3c601b9f31bf04019c8593c">광화문</label></li>
										<li><input type="checkbox"
											id="ff7d0f525b3be596a51fb919492c099c" value="1912"><label
											for="ff7d0f525b3be596a51fb919492c099c">남양주</label></li>
										<li><input type="checkbox"
											id="65fc52ed8f88c81323a418ca94cec2ed" value="1916"><label
											for="65fc52ed8f88c81323a418ca94cec2ed">대학로</label></li>
										<li><input type="checkbox"
											id="44968aece94f667e4095002d140b5896" value="1920"><label
											for="44968aece94f667e4095002d140b5896">망원</label></li>
										<li><input type="checkbox"
											id="b139e104214a08ae3f2ebcce149cdf6e" value="1924"><label
											for="b139e104214a08ae3f2ebcce149cdf6e">명동</label></li>
										<li><input type="checkbox"
											id="5bce843dd76db8c939d5323dd3e54ec9" value="1928"><label
											for="5bce843dd76db8c939d5323dd3e54ec9">문래</label></li>
										<li><input type="checkbox"
											id="52d2752b150f9c35ccb6869cbf074e48" value="1932"><label
											for="52d2752b150f9c35ccb6869cbf074e48">북촌</label></li>
										<li><input type="checkbox"
											id="95192c98732387165bf8e396c0f2dad2" value="2016"><label
											for="95192c98732387165bf8e396c0f2dad2">분당</label></li>
										<li><input type="checkbox"
											id="11108a3dbfe4636cb40b84b803b2fff6" value="1936"><label
											for="11108a3dbfe4636cb40b84b803b2fff6">상수</label></li>
										<li><input type="checkbox"
											id="6f2688a5fce7d48c8d19762b88c32c3b" value="1944"><label
											for="6f2688a5fce7d48c8d19762b88c32c3b">샤로수길</label></li>
										<li><input type="checkbox"
											id="7ca57a9f85a19a6e4b9a248c1daca185" value="1948"><label
											for="7ca57a9f85a19a6e4b9a248c1daca185">서래마을</label></li>
										<li><input type="checkbox"
											id="1113d7a76ffceca1bb350bfe145467c6" value="1952"><label
											for="1113d7a76ffceca1bb350bfe145467c6">서촌</label></li>
										<li><input type="checkbox"
											id="e3408432c1a48a52fb6c74d926b38886" value="1956"><label
											for="e3408432c1a48a52fb6c74d926b38886">성수</label></li>
										<li><input type="checkbox"
											id="7f16109f1619fd7a733daf5a84c708c1" value="1960"><label
											for="7f16109f1619fd7a733daf5a84c708c1">송도</label></li>
										<li><input type="checkbox"
											id="39dcaf7a053dc372fbc391d4e6b5d693" value="1964"><label
											for="39dcaf7a053dc372fbc391d4e6b5d693">압구정</label></li>
										<li><input type="checkbox"
											id="98c7242894844ecd6ec94af67ac8247d" value="1968"><label
											for="98c7242894844ecd6ec94af67ac8247d">양재</label></li>
										<li><input type="checkbox"
											id="c4de8ced6214345614d33fb0b16a8acd" value="1972"><label
											for="c4de8ced6214345614d33fb0b16a8acd">양평</label></li>
										<li><input type="checkbox"
											id="dd055f53a45702fe05e449c30ac80df9" value="1976"><label
											for="dd055f53a45702fe05e449c30ac80df9">여의도</label></li>
										<li><input type="checkbox"
											id="f80bf05527157a8c2a7bb63b22f49aaa" value="1980"><label
											for="f80bf05527157a8c2a7bb63b22f49aaa">연남</label></li>
										<li><input type="checkbox"
											id="1b36ea1c9b7a1c3ad668b8bb5df7963f" value="1984"><label
											for="1b36ea1c9b7a1c3ad668b8bb5df7963f">을지로</label></li>
										<li><input type="checkbox"
											id="9d7311ba459f9e45ed746755a32dcd11" value="1988"><label
											for="9d7311ba459f9e45ed746755a32dcd11">이태원</label></li>
										<li><input type="checkbox"
											id="d5c186983b52c4551ee00f72316c6eaa" value="1992"><label
											for="d5c186983b52c4551ee00f72316c6eaa">익선동</label></li>
										<li><input type="checkbox"
											id="6351bf9dce654515bf1ddbd6426dfa97" value="1996"><label
											for="6351bf9dce654515bf1ddbd6426dfa97">인사동</label></li>
										<li><input type="checkbox"
											id="08f90c1a417155361a5c4b8d297e0d78" value="2000"><label
											for="08f90c1a417155361a5c4b8d297e0d78">일산</label></li>
										<li><input type="checkbox"
											id="b8b4b727d6f5d1b61fff7be687f7970f" value="2004"><label
											for="b8b4b727d6f5d1b61fff7be687f7970f">잠실</label></li>
										<li><input type="checkbox"
											id="ef8446f35513a8d6aa2308357a268a7e" value="2008"><label
											for="ef8446f35513a8d6aa2308357a268a7e">종로</label></li>
										<li><input type="checkbox"
											id="253614bbac999b38b5b60cae531c4969" value="2012"><label
											for="253614bbac999b38b5b60cae531c4969">청담동</label></li>
										<li><input type="checkbox"
											id="7b7a53e239400a13bd6be6c91c4f6c4e" value="2020"><label
											for="7b7a53e239400a13bd6be6c91c4f6c4e">한남동</label></li>
										<li><input type="checkbox"
											id="95e6834d0a3d99e9ea8811855ae9229d" value="1940"><label
											for="95e6834d0a3d99e9ea8811855ae9229d">합정</label></li>
										<li><input type="checkbox"
											id="07811dc6c422334ce36a09ff5cd6fe71" value="2024"><label
											for="07811dc6c422334ce36a09ff5cd6fe71">해방촌</label></li>
										<li><input type="checkbox"
											id="d860edd1dd83b36f02ce52bde626c653" value="2028"><label
									...
									<ul class="content"
										data-dist="b0ef0d66131a078e03dca528a125403b">
										<li><input type="checkbox"
									...
									<ul class="content scroll"
										...
										<li><input type="checkbox"
											id="4c5bcfec8584af0d967f1ab10179ca4b" value="2372"><label
											for="4c5bcfec8584af0d967f1ab10179ca4b">수원시 장안구</label></li>
										<li><input type="checkbox"
											id="eb0ecdb070a1a0ac46de0cd733d39cf3" value="2560"><label
											for="eb0ecdb070a1a0ac46de0cd733d39cf3">수원시 팔달구</label></li>
										<li><input type="checkbox"
											id="81c2f886f91e18fe16d6f4e865877cb6" value="2704"><label
											for="81c2f886f91e18fe16d6f4e865877cb6">시흥시</label></li>
										<li><input type="checkbox"
											id="d0010a6f34908640a4a6da2389772a78" value="2808"><label
											for="d0010a6f34908640a4a6da2389772a78">안산시 단원구</label></li>
										<li><input type="checkbox"
											id="f3b7e5d3eb074cde5b76e26bc0fb5776" value="2812"><label
											for="f3b7e5d3eb074cde5b76e26bc0fb5776">안산시 상록구</label></li>
										<li><input type="checkbox"
										...
										<li><input type="checkbox"
											id="b139aeda1c2914e3b579aafd3ceeb1bd" value="2828"><label
											for="b139aeda1c2914e3b579aafd3ceeb1bd">안양시 만안구</label></li>
										<li><input type="checkbox"
								...
								<button class="confirm red_fill border_radius soft"
									type="button" tabindex="-1">확인</button>
							</div>
						</div>
							...
							<div id="nav_recommend" class="border_radius soft">
								...
								<ul class="recent">
									<li class="title">최근 본 매장
										<div>
											<i class="icon arrow xs prev"></i><span class="page">1</span><span>4</span><i
												class="icon arrow xs next"></i>
										</div>
									</li>
									<li class="item" data-id="35740"><span>만</span></li>
									<li class="item" data-id="37576"><span>투뿔등심 고담
											(삼성점)</span></li>
									<li class="item" data-id="45600"><span>나무식탁</span></li>
									<li class="item" data-id="45800"><span>몽상가 크레이프</span></li>
									<li class="item" data-id="28622"><span>라미띠에</span></li>
									<li class="item" data-id="43900" style="display: none;"><span>녹턴
											사카바</span></li>
									<li class="item" data-id="41500" style="display: none;"><span>반비반스</span>
									</li>
									<li class="item" data-id="630" style="display: none;"><span>신선설농탕
											(서초점)</span></li>
									<li class="item" data-id="600" style="display: none;"><span>서해쭈꾸미</span>
									</li>
									<li class="item" data-id="310" style="display: none;"><span>월남쌈도곡점</span>
									</li>
									<li class="item" data-id="300" style="display: none;"><span>타워한우</span>
									</li>
									<li class="item" data-id="100" style="display: none;"><span>시추안
											하우스 (삼성점)</span></li>
									<li class="item" data-id="1000" style="display: none;"><span>왕창</span>
									</li>
									<li class="item" data-id="40000" style="display: none;"><span>익스퍼</span>
									</li>
									<li class="item" data-id="6400" style="display: none;"><span>강촌매운탕</span>
									</li>
									<li class="item" data-id="10000" style="display: none;"><span>대구
											반야월 막창</span></li>
									<li class="item" data-id="2000" style="display: none;"><span>영동왕족발</span>
									</li>
									<li class="item" data-id="32696" style="display: none;"><span>아벡누</span>
									</li>
									<li class="item" data-id="12413" style="display: none;"><span>피에르
											가니에르 서울</span></li>
								</ul>
							</div>
				...
				<div class="menu_wrap">
					<div id="nav_menu">
						<a href="/seoul/event" class="underline ">이벤트</a> <a
							href="/seoul/restaurant" class="underline ">추천 테마</a> <a
							href="/seoul/review" class="underline ">리뷰</a> <a
							href="/magazine" class="underline ">매거진<!--<i class="text new"></i>--></a>
					</div>
				</div>
			</div>
			<!-- //navgation -->
