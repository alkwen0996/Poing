...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.ad" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Form elements</a> <a href="#" class="current">Validation</a> </div>
