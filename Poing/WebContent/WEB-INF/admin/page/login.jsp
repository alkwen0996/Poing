...
<head>
    ...
    <%@include file="/admin/css/matrix-login.css" %>
...
<body>
    <div id="loginbox">
        <form id="loginform" class="form-vertical" action="index.ad">
            ...
            <div class="form-actions">
                <span class="pull-left"><a href="#" class="flip-link btn btn-info" id="to-recover">Lost
                        password?</a></span>
                <span class="pull-right"><a type="submit" href="index.ad" class="btn btn-success" /> Login</a></span>
            </div>
        </form>
