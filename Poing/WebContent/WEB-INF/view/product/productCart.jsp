...
<div class="pay cart">
        ...
        <table>
            ...
            <tbody>
                                        <tr class="selected" data-id="1298104" data-valid="false">
                            <td class="select">
                            ...
                            <td class="info">
                                ...
                                <button type="button" class="option border_radius soft" data-id="1298104" tabindex="-1">옵션변경</button>
                                ...
                                <ul class="options">
                                            ...
                                            <button type="button" class="reset" data-id="1298104" data-opt="17324" tabindex="-1"></button>
                                        </li>
                                                                    </ul>
                            </td>
                            <td class="reserve">
                                                                    <p>예약일을 지정해주세요.</p>
                                    <button type="button" class="reserve" data-id="1298104" data-mode="cart" tabindex="-1">예약하기</button>
                                                            </td>
                        </tr>
                ...
                <span class="value">3,524,000원</span>
            </div>
            </div>
