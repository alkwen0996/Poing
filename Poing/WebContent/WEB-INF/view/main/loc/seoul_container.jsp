							...
							<div class="element  main_review first ">
								...
								<div class="desc">
									<div class="author">
										...
										<div class="preview">
											<span>솔직히 말하자면 돈 아깝습니다. 고기의 신선도가 떨어지는 느낌에 식사와 후식은 이도저도
												아닌 맛에 거의 남겼네요. 서비스가 친절하지도 않아요! </span> <a
							...
							<div class="element  main_review first ">
								...
								<div class="desc">
									<div class="author">
										...
										<div class="preview">
											<span>친구가 사줘서 방문. 스테이크가 그렇게 특별하지 않았지만 의외로 파스타가 매우 인상적.
												하지만 가격은 사악</span> <a href="/restaurant/detail/26680?review"
												class="more">더보기 &gt;</a>
										</div>
									</div>
								</div>
							...
							<div class="element  main_review  ">
								...
								<div class="desc">
									<div class="author">
										...
										<div class="preview">
											<span>난 여기 너무 맛있음. 같이 간 사람들도 항상 맛있다고 함. 전에 사라진 달팽이 스프
												그립다. 다시 돌아오길.</span> <a href="/restaurant/detail/28402?review"
												class="more">더보기 &gt;</a>
										</div>
									</div>
								</div>
							...
							<div class="element  main_review first ">
								...
								<div class="desc">
									<div class="author">
										...
										<div class="preview">
											<span>난 이집이 왜 유명한지 모르겠음. 맛도 평범하고 결정적으로 상암에 멀리 사는 나로서는
												굳이 여기올 이유는 전혀 없음.</span> <a href="/restaurant/detail/30168?review"
												class="more">더보기 &gt;</a>
										</div>
									</div>
								</div>
							...
							<div class="element  main_review  ">
								...
								<div class="desc">
									<div class="author">
										...
										<div class="preview">
											<span>친구가 관악에 파스타 맛집이 있다고 해서 내가 무슨 파스타먹으러 관악을 가냐고 욕했지만
												그럴 가치가 있었다. 친구야 미안ㅋㅋㅋ사실 2번갔어</span> <a
							...
							<div class="element  main_review  ">
								...
								<div class="desc">
									<div class="author">
										...
										<div class="preview">
											<span>전설의 그라노. 그러나 테라13이나 스코파더가 더 나은듯. 그래도 한번쯤은 가보는게?</span>
											<a href="/restaurant/detail/1117?review" class="more">더보기
												&gt;</a>
										</div>
									</div>
								</div>
