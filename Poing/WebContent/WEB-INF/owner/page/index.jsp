...
<div id="content">
	...
	<div id="content-header">
		<div id="breadcrumb">
			<a href="index.ow" title="Go to Home" class="tip-bottom"><i
	...
	<div class="container-fluid">
		<div class="quick-actions_homepage">
			<ul class="quick-actions">
				<!-- <li class="bg_lg span3"> <a href="charts.ow"> <i class="icon-signal"></i> Charts</a> </li>
		       <li class="bg_ly"> <a href="widgets.ow"> <i class="icon-inbox"></i><span class="label label-success">101</span> Widgets </a> </li>
		       <li class="bg_lo"> <a href="tables.ow"> <i class="icon-th"></i> Tables</a> </li>
		       <li class="bg_ls"> <a href="grid.ow"> <i class="icon-fullscreen"></i> Full width</a> </li>
		       <li class="bg_lo span3"> <a href="form-common.ow"> <i class="icon-th-list"></i> Forms</a> </li>
		       <li class="bg_ls"> <a href="buttons.ow"> <i class="icon-tint"></i> Buttons</a> </li>
		       <li class="bg_lb"> <a href="interface.ow"> <i class="icon-pencil"></i>Elements</a> </li>
		       ...
		       <li class="bg_lr"> <a href="error404.ow"> <i class="icon-info-sign"></i> Error</a> </li> -->
				...
				<li class="bg_lr">
					...
					<i class="icon-comment"></i>레스토랑 리뷰
					</a>
				</li>
				<li class="bg_lr">
					<a href="rest_image.ow"> 
					<i class="icon-picture"></i>레스토랑 사진
					</a>
				</li>
				<li class="bg_lr">
					<a href="rest_menu.ow">
					<i class="icon-list-alt"></i>레스토랑 메뉴
					</a>
				</li>
				<li class="bg_lr">
					<a href="rest_menu.ow">
						...
						<ul class="recent-posts">
							<li>
								...
								<div class="article-post">
									<span class="user-info"> By: john Deo / Date: 2 Aug
							...
							<li>
								...
								<div class="article-post">
									...
									<p>
										<a href="#">This is a much longer one that will go on for
											a few lines.Itaffle to pad out the comment.</a>
									</p>
								</div>
							<li>
					...
					<div class="widget-content">
						<div class="todo">
							<ul>
								...
								<li class="clearfix">
									<div class="txt">
										Today we celebrate the theme <span
											class="date badge badge-info">08.03.2013</span>
									</div>
									<div class="pull-right">
										<a class="tip" href="#" title="Edit Task"><i
											class="icon-pencil"></i></a> <a class="tip" href="#"
								...
								<li class="clearfix">
									<div class="txt">
										Manage all the orders <span
											class="date badge badge-important">12.03.2013</span>
									</div>
									<div class="pull-right">
										<a class="tip" href="#" title="Edit Task"><i
											class="icon-pencil"></i></a> <a class="tip" href="#"
					...
					<div class="widget-content nopadding updates collapse in"
						...
						<div class="new-update clearfix">
							...
							<div class="update-done">
								<a title="" href="#"><strong>Lorem ipsum dolor sit
										amet, consectetur adipiscing elit.</strong></a> <span>dolor sit
									amet, consectetur adipiscing eli</span>
							</div>
						...
						<div class="new-update clearfix">
							<i class="icon-gift"></i> <span class="update-notice"> <a
								title="" href="#"><strong>Congratulation Maruti,
										Happy Birthday </strong></a> <span>many many happy returns of the
									day</span>
						...
						<div class="new-update clearfix">
							<i class="icon-move"></i> <span class="update-alert"> <a
								title="" href="#"><strong>Maruti is a Responsive
										Admin theme</strong></a> <span>But already everything was solved.
									It will ...</span>
						...
						<div class="new-update clearfix">
							<i class="icon-question-sign"></i> <span class="update-notice">
								<a title="" href="#"><strong>I am alwayse here if
										you have any question</strong></a> <span>we glad that you choose
									our template</span>
						...
						<div class="chat-users panel-right2">
							...
							<div class="panel-content nopadding">
								<ul class="contact-list">
									<li id="user-Alex" class="online"><a href=""><img
											alt="" src="img/demo/av1.jpg" /> <span>Alex</span></a></li>
									...
									<li id="user-Mark" class="online"><a href=""><img
											alt="" src="img/demo/av4.jpg" /> <span>Mark</span></a></li>
									<li id="user-Maxi" class="online"><a href=""><img
											alt="" src="img/demo/av5.jpg" /> <span>Maxi</span></a></li>
								</ul>
							</div>
						</div>
				...
				<div class="accordion" id="collapse-group">
					<div class="accordion-group widget-box">
						...
						<div class="collapse in accordion-body" id="collapseGOne">
							<div class="widget-content">It has multiple paragraphs and
								is full of waffle to pad out the comment. Usually, you just
								wish these sorts of comments would come to an end.</div>
						</div>
					</div>
					<div class="accordion-group widget-box">
						<div class="accordion-heading">
						...
						<div class="collapse accordion-body" id="collapseGTwo">
							<div class="widget-content">And is full of waffle to It
								has multiple paragraphs and is full of waffle to pad out the
